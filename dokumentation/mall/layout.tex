...
\rhead{\ifdef{\LIPSutfardare}{Issued by \LIPSutfardare \\\LIPSdatum}\LIPSdatum}
...
{\ }\vspace{45mm}
\begin{center}
	\textbf{\Huge \LIPSkursnamn}
\end{center}
\begin{center}
  \textbf{\Huge \LIPSdokument}
\end{center}
\begin{center}
	\textbf{\Large \LIPSprojektgrupp}
\end{center}
\begin{center}
...
\begin{center}
  {\small
    ...
    \ifdef{\LIPSkund}{\textbf{Customer}: \LIPSkund\\}{}
    \ifdef{\LIPSkundkontakt}{\textbf{Contact at customer}: \LIPSkundkontakt\\}{}
    \ifdef{\LIPSkursansvarig}{\textbf{Course resposible}: \LIPSkursansvarig\\}{}
    \ifdef{\LIPShandledare}{\textbf{Consultant}: \LIPShandledare\\}{}
  }
\end{center}
\newpage
}
...
\begin{center}
  ...
  %\begin{small}
    \begin{tabular}{|l|l|p{60mm}|l|}
      \hline
      \textbf{Version} & \textbf{Date} & \textbf{Changes} & \textbf{Performed by} \\
      }%
    {%
			\hline
    \end{tabular}
...
\newcommand{\LIPSversionsinfo}[4]{\hline {#1} & {#2} & {#3} & {#4} \\}
...
\newenvironment{LIPSmilstolpar}{
	\center
		\tabularx{\textwidth}{| p{1.2cm} | X | l |}
			\hline
			\textbf{\#} & \textbf{Description} & \textbf{Date} \\\hline
}
{
		\endtabularx
	\endcenter
...
\newenvironment{LIPSaktivitetslista}{
	\center
		\tabularx{\textwidth}{| p{0.3cm} | X | c | c | c |}
			\hline
			\textbf{\#} & \textbf{Description} & \textbf{Dependenies} & \textbf{Hours} & \textbf{Date} \\\hline
}
{
		\endtabularx
	\endcenter
